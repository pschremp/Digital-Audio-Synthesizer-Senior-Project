...
// RETURN RX FLAG STATE (1 = new data, 0 = old data)
uint8_t USART6_GET_RX_FLAG()
{
	return rx_flag; //returns the state of the RX flag
}

// RESET RX FLAG TO 0 (AFTER EXTERNAL READ)
void USART6_RESET_RX_FLAG()
{
	rx_flag = 0; //resets the RX flag to 0
}
/* USER CODE END 0 */
